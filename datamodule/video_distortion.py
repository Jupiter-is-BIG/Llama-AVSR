...
building block used by RandomVideoDistortion (training) and VideoDistortion
(eval, if added later) in transforms.py.
"""
import os
import random
import tempfile
...
# (e.g. from an ad-hoc script) -- a per-sample ffmpeg subprocess is too slow
# inside a DataLoader, so training/eval transforms never select it.
